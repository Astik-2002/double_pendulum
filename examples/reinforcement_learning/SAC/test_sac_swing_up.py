...
if robot == "pendubot":
    ...
    design = "design_A.0"
    model = "model_2.0"
    model_path = "/home/astik/double_pendulum/data/policies/design_A.0/model_2.0/pendubot/SAC/sac_model"
    scaling_state = True

    # design = "design_C.1"
    # model = "model_1.0"
    # model_path = "/home/astik/double_pendulum/data/policies/design_C.1/model_1.0/pendubot/SAC/sac_model.zip"
    # scaling_state = False
